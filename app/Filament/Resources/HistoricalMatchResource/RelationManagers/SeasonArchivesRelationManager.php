...
class SeasonArchivesRelationManager extends RelationManager
{
    protected static string $relationship = 'seasonArchives';

    protected static ?string $title = 'Season Archives';
        ...
        return $table
            ...
            ->headerActions([
                Tables\Actions\AttachAction::make()
                    ->label('Attach Season Archive')
                    ->recordTitle(fn ($record) => $record->title)
                    ->recordSelectSearchColumns(['title', 'slug', 'season_label'])
                    ->preloadRecordSelect()
